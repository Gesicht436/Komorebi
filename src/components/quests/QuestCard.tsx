      ...
      <div className="flex items-start gap-3 sm:gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex flex-wrap items-center gap-2 mb-1.5">
            ...
            >
              <AttributeIcon className="w-3 h-3" />
              {attrConfig.label}
            </span>
        ...
        {/* Action Buttons (Visible on hover/focus or mobile) */}
        <div
        ...
        >
          <button
            ...
            className="p-1.5 rounded-lg text-[#8D6E63] hover:text-[#3E2723] hover:bg-[#F5EFEB] transition-colors"
          >
          ...
          <button
            ...
            className="p-1.5 rounded-lg text-[#8D6E63] hover:text-[#D32F2F] hover:bg-[#FFEBEE] transition-colors"
          >
